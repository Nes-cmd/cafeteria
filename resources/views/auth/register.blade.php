            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">Your Organization</label>
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Work-place') }}</label>

                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('work_place') is-invalid @enderror" name="work_place" placeholder="e.g የተለየ የእስዎ ቦታ" value="{{ old('work_place') }}" required>
