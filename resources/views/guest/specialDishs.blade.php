    	...
    	<div class="row justify-content-center mb-5">
          <div class="col-md-7 heading-section text-center ftco-animate">
            ...
            <h2 class="mb-4" style="color: rgb(242,122,223);">ስፔሻል ምግቦቻችንን ይቅመሱ/Get our specials!</h2>
             <p style="color: white">ውድ ደንበኛችን ወደማዘዣው ጨመሩ ማለት አዘዙ ማለት አይደለም። ወደማዘዣ ያስገቡትን ምርት አንድ ላይ <a href="{{URL::to('customer/cart')}}">ለማዘዝ</a> የሚለውን በመንካትና አድራሻዎን በማስገባት ማዘዝ ይኖርቦታል!!!</p>
